...
$CCG $S_IN/462.libquantum.clang.cubex -h 105 -r 509.9 $PARAMS 2>&1 | tee $S_OUT/462.libquantum.clang.log
$CCG $S_IN/464.h264ref.clang.cubex    -h 105 -r 402.8 $PARAMS 2>&1 | tee $S_OUT/464.h264ref.clang.log
$CCG $S_IN/470.lbm.clang.cubex        -h 105 -r 71.2  $PARAMS 2>&1 | tee $S_OUT/470.lbm.clang.log
$CCG $S_IN/473.astar.clang.cubex      -h 105 -r 365.7 $PARAMS 2>&1 | tee $S_OUT/473.astar.clang.log
$CCG $S_IN/482.sphinx3.clang.cubex    -h 105 -r 157.1 $PARAMS 2>&1 | tee $S_OUT/482.sphinx3.clang.log
